...
exports.putFinalizarMueble = exports.getMueblesAsignadosUsuarioPorId = exports.deleteMueblePorId = exports.putActualizarMueble = exports.postInsertarMuebleListados = exports.postInsertarMueble = exports.getMateriasPrimasAsignadosMueble = exports.getUsuariosAsignadosMueble = exports.getMueblePorId = exports.getBuscarMueble = void 0;
...
const getMueblesAsignadosUsuarioPorId = (req, res) => {
    (0, mueble_model_1.buscarMueblesAsignadosUsuarioPorId)(req.params.id)
        .then((data) => {
        res.json(data);
    })
        .catch((err) => {
...
exports.getMueblesAsignadosUsuarioPorId = getMueblesAsignadosUsuarioPorId;
const putFinalizarMueble = (req, res) => {
    (0, mueble_model_1.finalizarMueble)(req.body.idMueble, req.body.idUsuario)
        .then((data) => {
        res.json(data);
    })
        .catch((err) => {
...
exports.putFinalizarMueble = putFinalizarMueble;
