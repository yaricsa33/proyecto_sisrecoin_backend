...
exports.getMueblesParaVentas = exports.deleteVentaPorId = exports.putActualizarVenta = exports.postInsertarVentaMueble = exports.getMueblesAsignadosVenta = exports.postInsertarVenta = exports.getbuscarVentaPorId = exports.getVenta = void 0;
...
const getMueblesAsignadosVenta = (req, res) => {
    (0, venta_models_1.buscarMueblesAsignadosVenta)(req.params.id)
        .then((data) => {
        res.json(data);
    })
        .catch((err) => {
...
exports.getMueblesAsignadosVenta = getMueblesAsignadosVenta;
