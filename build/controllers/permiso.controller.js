...
exports.deleteEliminarPermiso = exports.putActualizarPermiso = exports.postInsertarPermiso = exports.getPermisoPorIdRol = exports.getPermisoPorId = exports.getPermiso = void 0;
...
const getPermisoPorIdRol = (req, res) => {
    (0, permiso_model_1.buscarPermisoPorIdRol)(req.params.idRol)
        .then((data) => {
        res.json(data);
    })
        .catch((err) => {
...
exports.getPermisoPorIdRol = getPermisoPorIdRol;
