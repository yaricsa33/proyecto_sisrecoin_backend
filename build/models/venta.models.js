...
exports.actualizarVenta = exports.insertarMueble = exports.insertarMuebleVentas = exports.insertarVenta = exports.buscarMueblesParaVentas = exports.buscarMueblesAsignadosVenta = exports.eliminarVentaPorId = exports.buscarVentaPorId = exports.buscarVenta = void 0;
...
const buscarMueblesAsignadosVenta = (id) => {
    return new Promise((resolve, reject) => {
        db_config_1.default.query(`select m.idMueble,m.nombre,m.costoMateriaPrima, mv.valor from mueble m inner join muebleventa mv on m.idMueble = mv.idMueble 
      where mv.idVenta =${id}`, (err, res) => {
            let response = {};
            if (err) {
                response = Object.assign(Object.assign({}, response), { error: 400, mensaje: "error" });
                reject(response);
...
exports.buscarMueblesAsignadosVenta = buscarMueblesAsignadosVenta;
...
const insertarMuebleVentas = (listados) => {
    return new Promise((resolve, _reject) => __awaiter(void 0, void 0, void 0, function* () {
        for (let i = 0; i < listados.muebles.length; i++) {
            yield (0, exports.insertarMueble)(listados.muebles[i], listados.idVenta);
        }
        let response = {};
...
const insertarMueble = (mueble, idVenta) => {
