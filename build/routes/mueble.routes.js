...
router.get("/mueblesAsignadosTrabajador/:id", mueble_controller_1.getMueblesAsignadosUsuarioPorId);
...
router.put("/finalizarMueble", mueble_controller_1.putFinalizarMueble);
